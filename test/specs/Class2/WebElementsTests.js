...
describe("WebElements Test cases", () => {
  ...
  it("Verify login input fields and button are enabled by default", async () => {
    ...
    expect(isLoginEmailEnabled, "Login email input box is NOT enabled").to.be
      .true;
    ...
    expect(isLoginPwdEnabled, "Login password input box is NOT enabled").to.be
      .true;
  ...
  it("Verify error is displayed for incorrect login credentials", async () => {
    ...
    expect(isLoginErrorLinkEnabled, "Login error link is NOT enabled").to.be
      .true;

    const isLoginErrorLinkDisplayed = await loginErrorLink.isDisplayed();
    expect(isLoginErrorLinkDisplayed, "Login error link is NOT displayed").to.be
      .true;
    ...
    expect(isLoginErrorTextDisplayed, "Login error text is NOT displayed").to.be
      .true;
  });
});
